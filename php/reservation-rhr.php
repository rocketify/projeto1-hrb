...
$e_body = "Boas notícias! Você recebeu uma solicitação de reserva para o apartamento RHR Vista Mar.
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<script>window.location.assign('../ap_rhr_vista_mar.html');</script>";
