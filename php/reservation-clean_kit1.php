...
$e_subject = '[Clean Copacabana Kit 1] Solicitação de reserva';

$e_body = "Boas notícias! Você recebeu uma solicitação de reserva para o apartamento Clean Copacabana Kit 1.
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<script>window.location.assign('../ap_clean_copacabana_kit1.html');</script>";
...
Apartamento: Clean Copacabana Kit 1
Telefone: $telefone2
Hóspedes: $guests2
Checkin: $checkin2
Checkout: $checkout2
...
Apartment: Clean Copacabana Kit 1
Phone: $telefone2
Guests: $guests2
Checkin: $checkin2
