...
$e_subject = '[Clean Copacabana Kit 3] Solicitação de reserva';

$e_body = "Boas notícias! Você recebeu uma solicitação de reserva para o apartamento Clean Copacabana Kit 3.
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<script>window.location.assign('../ap_clean_copacabana_kit3.html');</script>";
...
Apartamento: Clean Copacabana Kit 3
Telefone: $telefone2
Hóspedes: $guests2
Checkin: $checkin2
Checkout: $checkout2
...
Apartment: Clean Copacabana Kit 3
Phone: $telefone2
Guests: $guests2
Checkin: $checkin2
