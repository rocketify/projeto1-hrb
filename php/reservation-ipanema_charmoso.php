...
$e_subject = '[Ipanema Charmoso] Solicitação de reserva';

$e_body = "Boas notícias! Você recebeu uma solicitação de reserva para o apartamento Ipanema Charmoso.
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<script>window.location.assign('../ap_ipanema_charmoso.html');</script>";
