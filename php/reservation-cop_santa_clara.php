...
$e_subject = '[Copacabana Santa Clara] Solicitação de reserva';

$e_body = "Boas notícias! Você recebeu uma solicitação de reserva para o apartamento Copacabana Santa Clara.
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<script>window.location.assign('../ap_copacabana_santa_clara.html');</script>";
...
Apartamento: Copacabana Santa Clara
Telefone: $telefone2
Hóspedes: $guests2
Checkin: $checkin2
Checkout: $checkout2
...
Apartment: Copacabana Santa Clara
Phone: $telefone2
Guests: $guests2
Checkin: $checkin2
